...
HEADER_NAV.addEventListener('click', (event)=>{
    ...
    if(event.target!=HEADER_NAV) event.target.parentNode.classList.add('navigation--item-selected');
})
...
PORTFOLIO_MENU.addEventListener('click', (event)=>{
    ...
    if(event.target!=PORTFOLIO_MENU) event.target.parentNode.classList.add('nav-item--selected');
})
...
BUTTON_VERTICAL.addEventListener('click', ()=>{
    if(!document.getElementById('windowVertical').classList.contains('windowOff')) document.getElementById('windowVertical').classList.add('windowOff');
    else document.getElementById('windowVertical').classList.remove('windowOff');
})

BUTTON_HORIZONTAL.addEventListener('click', ()=>{
    if(!document.getElementById('windowHorizontal').classList.contains('windowOff')) document.getElementById('windowHorizontal').classList.add('windowOff');
    else document.getElementById('windowHorizontal').classList.remove('windowOff');
})
